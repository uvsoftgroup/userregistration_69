...
public class UserRoleController {
    ...
    @PostMapping("/saveUserRoleUserRole/userRole")
    public UserRole saveUserRoleUserRole(@Valid @RequestBody UserRole userRole) {
        return userRoleService.saveUserRoleUserRole(userRole);
    }
