...
public class UserRoleServiceImpl implements UserRoleService {
    ...
    @Override
    public UserRole saveUserRoleUserRole (UserRole userRole) {
            return userRoleRepository.save(userRole);
    }

    @Override
    public UserRole updateUserRole(Long userRegistrationId, Long userRoleId, UserRole userRoleRequest) {
    ...
    @Override
    public ResponseEntity<?> deleteUserRole(Long userRoleId,Long userRegistrationId) {
