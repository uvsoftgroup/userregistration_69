...
public interface UserRoleService {
    ...
    Page<UserRole> getAllUserRoleByUserRegistrationId(Long userRegistrationId,Pageable pageable);
    UserRole updateUserRole(Long userRegistrationId,Long userRoleId,UserRole userRoleRequest);
    ResponseEntity<?> deleteUserRole(Long userRegistrationId,Long userRoleId);
    ResponseEntity<?> deleteUserRoleById(Long userRoleId);
    UserRole saveUserRoleUserRole (UserRole userRole);
